...
import { Github, Mail, Terminal, Cpu, Rocket, ChevronRight, Zap, Shield, BarChart3, Clock, Award, Play, ExternalLink, Binary, Send, CheckCircle2, Phone } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-16">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <a href="tel:+2348161501210" className="flex items-center gap-4 text-white hover:text-emerald-400 transition-colors group">
                                <div className="p-3 bg-slate-900 rounded-lg group-hover:bg-emerald-500/10"><Phone size={24} /></div>
                                +234 816 150 1210
                            </a>
                            <a href="tel:+2348071055757" className="flex items-center gap-4 text-white hover:text-emerald-400 transition-colors group">
                                <div className="p-3 bg-slate-900 rounded-lg group-hover:bg-emerald-500/10"><Phone size={24} /></div>
                                +234 807 105 5757
                            </a>
                        </div>
